...
const CreateReservation = () => {
	...
	const [start, setStart] = useState<Date>(moment(new Date()).toDate());
	const [end, setEnd] = useState<Date>(
		moment(new Date()).add(1, "hours").toDate()
	);
	...
	return (
		<div className="flex flex-col">
			...
			{workspace && (
				<div className="fixed left-0 right-0 bottom-0 bg-white rounded-t-xl border border-gray-200 p-4 flex flex-col space-y-4">
					<div className="p-2">
